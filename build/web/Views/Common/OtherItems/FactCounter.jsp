<%-- 
    Document   : FactCounter
    Created on : Jul 8, 2025, 1:57:27 PM
    Author     : admin
--%>
...
<section class="fact-counter-area" style="background-image:url(images/resources/fact-counter-bg.jpg);">
    <div class="container">
        <div class="sec-title text-center">
            ...
            <p>Hãy điểm qua những thành tựu ấn tượng mà phòng khám của chúng tôi đã đạt được!</p>
        </div>
        <div class="row">
            <!--Start single item-->
